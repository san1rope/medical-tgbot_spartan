...
async def cmd_my_questions(message: Union[types.Message, types.CallbackQuery], state: FSMContext):
    uid = message.from_user.id
    Config.logger.info(f"Handler called. {cmd_my_questions.__name__}. user_id={uid}")
